export default function Card({ title, totalCount }) {
 return (
  <div className='border-2 border-gray-300 rounded-md w-full py-6 text-center hover:border-blue-600 hover:border-2 hover:cursor-pointer transition duration-300 group'>
